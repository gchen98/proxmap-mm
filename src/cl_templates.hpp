...
template<typename T> void proxmap_t::setArg(cl::Kernel * &  kernel,int & index,T arg,const char * label){
  ostringstream oss;
...
template<typename T> void proxmap_t::writeToBuffer(cl::Buffer * & buffer,int dim,T hostArr,const char * label){
  ostringstream oss;
  T t;
...
template<typename T> void proxmap_t::readFromBuffer(cl::Buffer * & buffer,int dim,T hostArr,const char * label){
  ostringstream oss;
  T t;
